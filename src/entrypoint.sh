...
echo "Runtime ID: ${PROBE_ID}"

# Export all the environment variables

echo "Exporting variables"
PRTGMPPROBE__MOMO__DIR="${PRTGMPPROBE__MOMO__DIR:-/opt/paessler/mpprobe/monitoringmodules/}"
PRTGMPPROBE__MAX_SCHEDULING_DELAY="${PRTGMPPROBE__MAX_SCHEDULING_DELAY:-300}"
PRTGMPPROBE__HEARTBEAT_INTERVAL="${PRTGMPPROBE__HEARTBEAT_INTERVAL:-30}"
PRTGMPPROBE__NATS__CLIENT_NAME="${PRTGMPPROBE__NATS__CLIENT_NAME:-$PROBE_NAME}"

PRTGMPPROBE__LOGGING__CONSOLE__LEVEL="${PRTGMPPROBE__LOGGING__CONSOLE__LEVEL:-info}"
PRTGMPPROBE__LOGGING__CONSOLE__WITHOUT_TIME="${PRTGMPPROBE__LOGGING__CONSOLE__WITHOUT_TIME:-true}"
PRTGMPPROBE__LOGGING__JOURNALD__LEVEL="${PRTGMPPROBE__LOGGING__JOURNALD__LEVEL:-off}"
PRTGMPPROBE__LOGGING__JOURNALD__FIELD_PREFIX="${PRTGMPPROBE__LOGGING__JOURNALD__FIELD_PREFIX:-PRTGMPROBE}"
